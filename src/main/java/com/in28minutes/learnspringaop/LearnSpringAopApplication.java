...
public class LearnSpringAopApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		logger.info("Value businessService1 returned is {}", businessService1.calculateMax());
		logger.info("Value businessService2 returned is {}", businessService2.calculateMin());
	}
}
